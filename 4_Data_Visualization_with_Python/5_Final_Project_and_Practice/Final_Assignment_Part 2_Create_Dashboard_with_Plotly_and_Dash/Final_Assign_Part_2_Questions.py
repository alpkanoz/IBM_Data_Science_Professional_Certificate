...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style={"width": '80%', 'padding-left':'3px', 'font-size': '20px', 'text-align':'center'}
        )
    ]),
        html.Div(
            dcc.Dropdown(
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.line(average_sales, x='Vehicle_Type', y='Automobile_Sales', title="Average Sales by Vechicle Type over Recession Period"))
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales', title='Avarage Sales by Year'))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        montotal=yearly_data.groupby('Month')['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(figure=px.line(montotal, x='Month', y='Automobile_Sales', title='Total Sales by Month'))
