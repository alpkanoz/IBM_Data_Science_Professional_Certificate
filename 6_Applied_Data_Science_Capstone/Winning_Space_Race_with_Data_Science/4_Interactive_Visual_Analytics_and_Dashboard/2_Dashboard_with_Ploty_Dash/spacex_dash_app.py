...
def get_scatter_chart(value, payload_range):
    if value == 'ALL':
        ...
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
                     title='Correlation between Payload and Success for all Sites between {:8,d}kg and {:8,d}kg'.format(int(payload_range[0]),int(payload_range[1]))
                     )
    else: 
        ...
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category',
                     title='Correlation between Payload and Success for {} payload mass between {:8,d}kg and {:8,d}kg'.format(value,int(payload_range[0]),int(payload_range[1])))
